            ...
            <div className="w-60 max-w-full px-4 xl:mr-12">
              <a
                ...
                className={`header-logo block w-full ${
                  sticky ? "md:py-5 py-2 lg:py-2" : "py-6"
                } `}
              >
                <img
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div className="lg:flex grow justify-center">
                <button
                  ...
                  className="ring-primary !bg-transparent absolute top-1/2 right-4 block translate-y-[-50%] rounded-lg px-3 py-[6px] focus:ring-2 lg:hidden outline outline-white"
                >
                  <span
                ...
                <nav
                  id="navbarCollapse"
                  className={`grow navbar border-body-color/50 absolute right-5 z-50 w-[250px] rounded-lg border-[.5px] bg-black/80 px-6 py-4 duration-300 lg:visible lg:static lg:w-auto lg:border-none  lg:!bg-transparent lg:opacity-100 ${
                    navbarOpen
                    ...
                    {navigation.map((nav, index) => (
                      <li key={index} className="group relative">
                        {nav.href ? (
                          <a
                            href={nav.href}
                            className={`flex py-2 md:text-base text-sm font-bold lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                          ...
                          <>
                            ...
                            <div
                              className={`submenu relative top-full left-0 rounded-sm bg-black/80 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[250px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
