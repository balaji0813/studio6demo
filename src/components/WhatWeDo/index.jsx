            ...
            <div class="parent">
              ...
              <div class="div2 relative">
                <img
                  ...
                  className="w-full h-full object-cover"
                />
                <div className="absolute lg:text-5xl md:text-3xl text-xl text-primary top-0 left-0 right-0 bottom-0 text-center font-bold uppercase flex items-center justify-center bg-black/80">
                  Living
                </div>
              </div>
